...
Публичный лендос теперь работает как demo hub: с него можно перейти в кликабельную платформу, клиентский MVP-кабинет и операторскую админку.

Кликабельная продуктовая платформа:
