...
-- Сгенерировано из saas/migrations/. Выполнять в SQL Editor Supabase целиком, один раз.
-- Источник правды — отдельные файлы; этот файл можно пересобрать: node scripts/bundle-migrations.js
